...
export class Lohnsteuer2026Big {
    ...
    MZTABFB() {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(9756))).round(0, Big.roundDown); /**  Geändert für 2023  */
        }
        else {
            if (this.STKL == 2) {
                this.EFA = new Big(4260); /**  Geändert für 2022  */
                this.SAP = new Big(36);
                this.KFB = (this.ZKF.mul(new Big(9756))).round(0, Big.roundDown); /**  Geändert für 2023  */
            }
            else {
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(4878))).round(0, Big.roundDown); /**  Geändert für 2023  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    UPTAB26() {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(17800)) == -1) { /**  Geändert für 2023  */
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(914.51)); /**  Geändert für 2023  */
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, Big.roundDown);
            }
            else {
                if (this.X.cmp(new Big(69879)) == -1) { /**  Geändert für 2023  */
                    this.Y = (this.X.sub(new Big(17799))).div(this.ZAHL10000).round(6, Big.roundDown); /**  Geändert für 2023   */
...
Lohnsteuer2026Big.typeDirectory = {
    "af": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "AJAHR": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "ALTER1": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "ENTSCH": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "f": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "JFREIB": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "JHINZU": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "JRE4": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "JVBEZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "KRV": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "KVZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "LZZ": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "LZZFREIB": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "LZZHINZU": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "MBV": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "PKPV": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "PKV": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "PVS": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "PVZ": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "R": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "RE4": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "SONSTB": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "STERBE": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "STKL": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "VBEZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "VBEZM": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "VBEZS": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "VBS": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "VJAHR": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "VKAPA": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "VMT": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "ZKF": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "ZMVB": { type: Lohnsteuer2026Big._n, direction: Lohnsteuer2026Big._i }, "JRE4ENT": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "SONSTENT": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._i }, "BK": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "BKS": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "BKV": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "LSTLZZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "SOLZLZZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "SOLZS": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "SOLZV": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "STS": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "STV": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "VKVLZZ": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "VKVSONST": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._s }, "VFRB": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d }, "VFRBS1": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d }, "VFRBS2": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d }, "WVFRB": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d }, "WVFRBO": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d }, "WVFRBM": { type: Lohnsteuer2026Big._b, direction: Lohnsteuer2026Big._o, group: Lohnsteuer2026Big._d },
};
